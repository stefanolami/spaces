		...
		<>
			...
			<div className="w-full bg-white-spaces my-10 lg:my-20 3xl:my-32">
				<p className="w-[80%] mx-auto md:w-[70%] xl:w-[60%] max-w-[1000px]  font-nunito text-xs md:text-base lg:text-xl text-center text-midnight-spaces font-bold">
					...
					can be tailored and combined to suit a wide range of
					concepts, and our{' '}
					<Link
						href="/services"
						className="text-coral-spaces font-bold"
			...
			<div className="w-full bg-white-spaces my-10 lg:my-20 3xl:my-32">
				<p className="hidden w-[80%] mx-auto md:w-[70%] xl:w-[60%] max-w-[1000px]  font-nunito text-xs md:text-base lg:text-xl text-center text-black-spaces">
					Our{' '}
					<Link
						href="/facilities"
						className="text-coral-spaces font-bold"
