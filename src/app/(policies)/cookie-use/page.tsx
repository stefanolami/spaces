		...
		<div className="w-[90%] xl:w-[70%] mx-auto max-w-[1000px] pt-20 xl:pt-32 pb-16 xl:pb-32 text-primary">
			...
			<div className="space-y-6 font-nunito text-sm xl:text-base">
				<p>
					...
					technologies on our website www.timeandspaces.com (the
				...
				<p>
					Please note: Our booking system is managed via an embedded
					third-party service provider, <strong>Anny.co</strong>,
					which may also use cookies to process your booking requests.
					You can learn more about their data and cookie practices by
					visiting{' '}
					<strong className="underline">
						<a href="https://anny.co/en/privacy">
							Anny.co’s Privacy Policy.
						</a>
					</strong>
				</p>
